...
/**
 * CSV format for {@link InputModel}.
 */
public final class InputModelCsvFormat extends BinaryStreamFormat<InputModel> {
    /**
    ...
    @Override public Class<InputModel> getSupportedType() {
    ...
    @Override public ModelInput<InputModel> createInput(Class<? extends InputModel> dataType, String path, InputStream 
    ...
    @Override public ModelOutput<InputModel> createOutput(Class<? extends InputModel> dataType, String path, 
    ...
    private static final class Reader implements ModelInput<InputModel> {
        private final CsvParser parser;
        Reader(CsvParser parser) {
            this.parser = parser;
        }
        @Override public boolean readTo(InputModel object) throws IOException {
    ...
    private static final class Writer implements ModelOutput<InputModel> {
        private final CsvEmitter emitter;
        Writer(CsvEmitter emitter) {
            this.emitter = emitter;
        }
        @Override public void write(InputModel object) throws IOException {
