...
import ironpeace.modelgen.dmdl.io.InputModelInput;
import ironpeace.modelgen.dmdl.io.InputModelOutput;
 ...
 * INPUTを表すデータモデルクラス。
 */
@DataModelKind("DMDL")@ModelInputLocation(InputModelInput.class)@ModelOutputLocation(InputModelOutput.class)@
        PropertyOrder({"department", "yyyymm", "value"}) public class InputModel implements DataModel<InputModel>, 
        Writable {
    ...
    @Override@SuppressWarnings("deprecation") public void copyFrom(InputModel other) {
    ...
    @Override public String toString() {
        ...
        result.append("{");
        result.append("class=input_model");
